...
<img src="https://render.githubusercontent.com/render/math?math=M{fixed}(y) = \frac{F}{2} ( frac{B_{BH}{4} - y )">

<img src="https://render.githubusercontent.com/render/math?math=M{supported}(y) = \frac{F}{2} ( frac{B_{CB}{2} - y )">
